...
const userSchema = new mongoose.Schema({
  ...
  email: { type: String, unique: true, sparse: true, required: function () { return !this.phone; } },
  phone: { type: String, unique: true, sparse: true, required: function () { return !this.email; } },
  passwordHash: { type: String, required: function () { return !this.googleId && !this.phone; } },
